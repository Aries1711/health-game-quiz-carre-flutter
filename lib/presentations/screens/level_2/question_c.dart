...
import 'package:game_health_efa/presentations/screens/level_2/question_d.dart';
...
class QuestionCTwo extends StatefulWidget {
  final String title;
  QuestionCTwo({Key? key, required this.title}) : super(key: key);

  @override
  State<QuestionCTwo> createState() => _QuestionCTwoState();
}

class _QuestionCTwoState extends State<QuestionCTwo> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Center(
                      child:
                          Image.asset('assets/images/level_b/question_c.png'),
                    ),
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20, top: 20),
                      child: Text(
                        "Jawaban: Mengecek nadi korotis\nSetelah menelepon ambulans yang dilakukan berikutnya adalah memeriksa nadi. Pada orang awam yang menemukan korban tidak sadar sebaiknya tidak memeriksa nadi karena tidak tahu letaknya, dan menganggap orang yang tidak sadar atau tidak bernafas normal adalah korban henti jantung. Sedangkan untuk petugas kesehatan harus memeriksa nadi tidak boleh lebih dari 10 detik. Jika tidak menemukan denyut nadi karotis dalam waktu tersebut maka penolong wajib memulai kompresi dada. Korban henti jantung ditandai dengan Tidak sadarkan diri, Tidak ada denyut jantung, dan Tidak bernafas.",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Image.asset(
                              'assets/images/level_b/question_c.png',
                              height: 250,
                              fit: BoxFit.contain),
                        )
                      ],
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "3.	Apakah tindakan yang dilakukan di gambar tersebut?",
                          textAlign: TextAlign.start,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(

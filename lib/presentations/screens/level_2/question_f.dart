...
class QuestionFTwo extends StatefulWidget {
  final String title;
  QuestionFTwo({Key? key, required this.title}) : super(key: key);

  @override
  State<QuestionFTwo> createState() => _QuestionFTwoState();
}

class _QuestionFTwoState extends State<QuestionFTwo> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Center(
                      child:
                          Image.asset('assets/images/level_b/question_f.png'),
                    ),
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20, top: 20),
                      child: Text(
                        "Jawaban: Disamping kanan atau kiri pasien\nPosisi penolong berada di samping lengan kanan atau kiri pasien untuk memudahkan penolong saat melakukan kompresi dada dan melakukan bantuan pernapasan dengan napas buatan pada korban henti jantung dengan meminimalkan interupsi.",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Image.asset(
                              'assets/images/level_b/question_f.png',
                              height: 250,
                              fit: BoxFit.contain),
                        )
                      ],
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "6.	Posisi penolong yang paling tepat saat melakukan tindakan kompresi dada pada RJP pada orang dewasa dengan satu penolong setelah korban dalam posisi terbaring terlentang yaitu?",
                          textAlign: TextAlign.start,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Di samping lengan kanan atau kiri pasien",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Di samping kaki kanan atau kiri pasien",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,

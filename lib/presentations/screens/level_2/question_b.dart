...
class QuestionBTwo extends StatefulWidget {
  final String title;
  QuestionBTwo({Key? key, required this.title}) : super(key: key);

  @override
  State<QuestionBTwo> createState() => _QuestionBTwoState();
}

class _QuestionBTwoState extends State<QuestionBTwo> {

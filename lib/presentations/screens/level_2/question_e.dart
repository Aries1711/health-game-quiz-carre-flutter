...
import 'package:game_health_efa/presentations/screens/level_2/question_f.dart';
...
class QuestionETwo extends StatefulWidget {
  final String title;
  QuestionETwo({Key? key, required this.title}) : super(key: key);

  @override
  State<QuestionETwo> createState() => _QuestionETwoState();
}

class _QuestionETwoState extends State<QuestionETwo> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Center(
                      child:
                          Image.asset('assets/images/level_b/question_e.png'),
                    ),
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20, top: 20),
                      child: Text(
                        "Jawaban: Kompresi dada\nPenjelasan: Kompresei dada adalah Tindakan menyelematkan korban henti jantung dengan cara melakukan penekanan di tengah-tengah bagian dada atau sternum untuk menggantikan sementara jantung yang tidak dapat berkerja normal.",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Image.asset(
                              'assets/images/level_b/question_e.png',
                              height: 250,
                              fit: BoxFit.contain),
                        )
                      ],
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "5.	Berikut ini adalah tindakan penolong untuk memberikan bantuan RJP. Tindakan apakah yang dilakukan?",
                          textAlign: TextAlign.start,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Menghubungi pelayanan gawat darurat",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,

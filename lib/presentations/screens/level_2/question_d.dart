...
import 'package:game_health_efa/presentations/screens/level_2/question_e.dart';
...
class QuestionDTwo extends StatefulWidget {
  final String title;
  QuestionDTwo({Key? key, required this.title}) : super(key: key);

  @override
  State<QuestionDTwo> createState() => _QuestionDTwoState();
}

class _QuestionDTwoState extends State<QuestionDTwo> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    ...
                    Center(
                      child:
                          Image.asset('assets/images/level_b/question_d.png'),
                    ),
                    Padding(
                      padding: EdgeInsets.only(left: 20, right: 20, top: 20),
                      child: Text(
                        "Jawaban: Mengecek pernafasan\nPenolong harus memeriksa pernapasan korban dengan cara Melihat, Mendengarkan, dan Merasakan. Melihat yang artinya melihat adanya pergerakan dada korban. Mendengarkan yang artinya mendengarkan suara napas korban dengan cara mendekatkan telinga kita ke hidung dan mulut. Merasakan yang artinya merasakan hembusan udara yang keluar dari sistem pernafasan korban yaitu dari hidung atau mulut. Korban henti jantung di tandai dengan Tidak sadarkan diri, Tidak ada denyut jantung, dan Tidak bernapas.",
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Image.asset(
                              'assets/images/level_b/question_d.png',
                              height: 250,
                              fit: BoxFit.contain),
                        )
                      ],
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Align(
                        ...
                        child: Text(
                          "4.	Apakah tindakan yang dilakukan pada gambar tersebut?",
                          textAlign: TextAlign.start,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
